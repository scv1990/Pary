...
/**
 *
 * 类名称: EducationAdapter.java
 * 类描述:	 
 * 创建人:  hq
 * 创建时间: 2016年8月22日下午1:48:37
 * -------------------------修订历史------------
 * 修改人:
 * 修改时间:
 * 修改备注:
...
public class EducationAdapter extends BaseAdapter{
	 ...
	 * @param mContext
	 */
	public EducationAdapter(Context mContext, List<EducationEntity> list) {
		super();
	...
	@Override
	public EducationEntity getItem(int position) {
		if(data == null){
			return null;
		}
