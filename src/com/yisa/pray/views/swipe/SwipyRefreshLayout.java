...
package com.yisa.pray.views.swipe;
 ...
 * a menu item must be provided to allow refresh of the content wherever this gesture is used.
 * </p>
 */
public class SwipyRefreshLayout extends ViewGroup {
	...
	static final String LOG_TAG = SwipyRefreshLayout.class.getSimpleName();
	...
	public SwipyRefreshLayout(Context context, AttributeSet attrs) {
		...
		SwipyRefreshLayoutDirection direction = SwipyRefreshLayoutDirection.getFromInt(a2.getInt(
				R.styleable.SwipyRefreshLayout_direction, 0));
