...
public class LruMemoryCache<K, V> {
	 ...
	 * invoked when a value is evicted to make space, removed by a call to {@link #remove}, or replaced by a call to
	 * {@link #put}. The default
	 ...
	 * @param newValue
	 *            the new value for {@code key}, if it exists. If non-null,
