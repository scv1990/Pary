...
public final class SystemTool {
	...
	public static void hideKeyBoard(Activity aty) {
		((InputMethodManager) aty.getSystemService(Context.INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(aty
	 ...
	 * <b>警告</b> 必须是确定键盘显示时才能调用
	 */
	public static void hideIME(Activity aty) {
		View view = aty.getWindow().peekDecorView();
		if (view != null) {
